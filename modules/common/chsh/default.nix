...
with lib; let
  ...
  mkWrapper = users: let
    usersWithNonDefaultShells = lib.filterAttrs (_: shell: !(builtins.elem shell defaultShells)) users;
    usersWithNormalizedShells = lib.mapAttrs (_: normalizeShellPath) usersWithNonDefaultShells;
  in
