...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "dsully";
    repo = pname;
    rev = "dc18c1909a525187fd7e640e7dbe282e9059e951";
    hash = "sha256-dSxjTPzOr//vAzwDICWWtLErVVcaqbTLJtS7Mp4LF7k=";
  };

  cargoHash = "sha256-O+SnsPk2f40AA5h3qTmB4X8VQ43i6+civ5+6aq3tE0c=";
